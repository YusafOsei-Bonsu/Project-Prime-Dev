...
Because the ElectronJS website provides code to create windows and webpages, we decided to use their code as the starting foundation for the development of the desktop application. 
