...
\subsection{\underline{Server Application}}
The server application is developed using Node.js and the database used is a cloud service by MongoDB.

\subsection{\underline{Desktop Client}}
The desktop application is built using the Electron framework; thus, the implementation primarily involved HTML, Javascript and CSS coding.

\subsection{\underline{Mobile Client}}
The mobile application is developed using Android Studio; thus, the implementation primarily involved Java and XML.
