...
\subsection{\underline{Desktop Client}}
The desktop client was developed using  HTML, Javascript and CSS on Electron. Electron provides pre-written HTML code (Electron, n.d.) that creates a basic desktop app; this pre-written code was used as the foundation for the development of the desktop client. Afterwards, the client's front-end was modified using JS, HTML and CSS to reflect the project designs. Furthermore on the desktop client's front-end, Bootstrap CSS files and JS scripts (Bootstrap, n.d.) were also included to style certain elements of the client's UI, along with CSS files written by the desktop subgroup.

\begin{figure}[h]
\caption{\textbf{CSS files provided by Bootstrap}}
\includegraphics[width=12cm, height=2cm]{BootstrapCSSfiles}
\end{figure}

\begin{figure}[h]
\caption{\textbf{JS scripts provided by Bootstrap file}}
\includegraphics[width=12cm, height=2cm]{BootstrapJSscripts}
\end{figure}

\begin{figure}[h]
\caption{\textbf{CSS file written by the desktop subgroup}}
\includegraphics[width=8cm, height=5cm]{css}
\end{figure}
